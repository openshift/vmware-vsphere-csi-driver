...
require (
	...
	k8s.io/cli-runtime v0.26.8 // indirect
	k8s.io/cloud-provider v0.26.8 // indirect
	k8s.io/component-base v0.26.8 // indirect
	k8s.io/component-helpers v0.26.8 // indirect
	k8s.io/cri-api v0.0.0 // indirect
	k8s.io/csi-translation-lib v0.26.8 // indirect
	k8s.io/dynamic-resource-allocation v0.0.0 // indirect
	k8s.io/klog/v2 v2.90.1 // indirect
	k8s.io/kube-openapi v0.0.0-20221012153701-172d655c2280 // indirect
	k8s.io/kube-scheduler v0.26.8 // indirect
	k8s.io/kubelet v0.26.8 // indirect
...
replace (
	...
	k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.26.8
	...
	k8s.io/node-api => k8s.io/node-api v0.26.8
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.26.8
	k8s.io/sample-controller => k8s.io/sample-controller v0.26.8
)
