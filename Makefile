...
unit unit-test:
	env -u VSPHERE_SERVER -u VSPHERE_DATACENTER -u VSPHERE_PASSWORD -u VSPHERE_USER -u VSPHERE_STORAGE_POLICY_NAME -u KUBECONFIG -u WCP_ENDPOINT -u WCP_PORT -u WCP_NAMESPACE -u TOKEN -u CERTIFICATE -u KUBERNETES_SERVICE_HOST -u KUBERNETES_SERVICE_PORT go test $(TEST_FLAGS) $(PKGS_WITH_TESTS)
unit-cover:
	env -u VSPHERE_SERVER -u VSPHERE_DATACENTER -u VSPHERE_PASSWORD -u VSPHERE_USER -u VSPHERE_STORAGE_POLICY_NAME -u KUBECONFIG -u WCP_ENDPOINT -u WCP_PORT -u WCP_NAMESPACE -u TOKEN -u CERTIFICATE -u KUBERNETES_SERVICE_HOST -u KUBERNETES_SERVICE_PORT go test $(TEST_FLAGS) $(PKGS_WITH_TESTS) && go tool cover -html=cover.out
build-unit-tests:
